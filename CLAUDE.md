...
MCP server is done (`interfaces/mcp/`, 15 tools, 40 tests + 7 posture, `oc mcp serve`
...
- **MCP Server**: Interfaces driver in `interfaces/mcp/` (optional extra, 15 tools, FastMCP)
