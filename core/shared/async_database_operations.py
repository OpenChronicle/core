...
async def async_query(story_id: str, query: str, params: tuple = None, is_test: bool = None) -> List[Dict[str, Any]]:
...
async def async_update(story_id: str, query: str, params: tuple = None, is_test: bool = None) -> bool:
    """Execute async update - utility function."""
    db_ops = AsyncDatabaseOperations(story_id, is_test)
    return await db_ops.execute_update(query, params)


async def async_insert(story_id: str, query: str, params: tuple = None, is_test: bool = None) -> Optional[int]:
