...
async def async_execute_query(story_id: str, query: str, params: Optional[tuple] = None, 
                            is_test: Optional[bool] = None) -> List[Dict[str, Any]]:
...
async def async_execute_update(story_id: str, query: str, params: Optional[tuple] = None, 
                             is_test: Optional[bool] = None) -> bool:
...
async def async_execute_insert(story_id: str, query: str, params: Optional[tuple] = None, 
                             is_test: Optional[bool] = None) -> Optional[int]:
