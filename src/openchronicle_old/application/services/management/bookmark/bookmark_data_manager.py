...
from openchronicle.shared.logging_system import log_system_event, log_warning

from ..shared import BookmarkManagerException, BookmarkRecord, BookmarkType
...
class BookmarkDataManager:
    ...
    def create_bookmark(
        ...
        try:
            ...
            if existing:
                raise BookmarkManagerException(f"Bookmark with label '{label}' already exists for scene {scene_id}")
    ...
    def get_bookmarks_with_scenes(self, bookmark_type: BookmarkType | None = None) -> list[dict[str, Any]]:
