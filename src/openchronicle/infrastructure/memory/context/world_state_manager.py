...
class WorldStateManager:
    ...
    def __init__(self):
        ...
        self.critical_world_states = {
            "time_of_day", "current_location", "weather", "season",
            "political_climate", "economic_status", "threat_level"
        }
        ...
        self.world_categories = {
            ...
            "economic": ["economic_status", "trade_conditions", "resource_availability"],
    ...
    def update_world_state(self, memory: MemorySnapshot, updates: Dict[str, Any],
                          source: str = "system", description: str = "") -> WorldStateUpdate:
        """
    ...
    def add_world_event(self, memory: MemorySnapshot, event_description: str,
                       event_type: str = "general", event_data: Dict[str, Any] = None,
                       characters_involved: List[str] = None,
                       location: str = None) -> WorldEvent:
        """
    ...
    def add_memory_flag(self, memory: MemorySnapshot, flag_name: str,
                       flag_data: Dict[str, Any] = None, 
                       flag_type: str = "general",
                       expires_at: Optional[datetime] = None) -> MemoryFlag:
        """
    ...
    def get_active_flags(self, memory: MemorySnapshot, 
                        flag_type: str = None) -> List[MemoryFlag]:
    ...
    def query_events(self, memory: MemorySnapshot, 
                    event_filter: EventFilter) -> List[WorldEvent]:
    ...
    def analyze_world_state(self, memory: MemorySnapshot) -> WorldStateAnalysis:
        ...
        try:
            ...
            missing_critical = [
                state for state in self.critical_world_states 
    ...
    def get_world_state_summary(self, memory: MemorySnapshot, 
        ...
        try:
            ...
            if category and category in self.world_categories:
                ...
                return {
                    key: value for key, value in world_state.items()
    ...
    def _validate_world_state_updates(self, updates: Dict[str, Any], 
    ...
    def _log_world_state_changes(self, updates: Dict[str, Any], source: str):
        ...
        critical_changes = [
            ...
            if key in self.critical_world_states
        ]
