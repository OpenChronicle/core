...
class SceneContextManager:
    ...
    def __init__(self):
        ...
        self.narrative_focuses = [
            ...
            "conflict_resolution", "relationship_dynamics", "mystery_revelation"
        ]
    
    def create_scene_context(self, memory: MemorySnapshot, scene_id: str,
                           location: str, active_characters: List[str],
                           scene_type: str = "dialogue",
                           narrative_focus: str = "character_development") -> SceneContext:
        """
    ...
    def analyze_scene_transition(self, from_context: SceneContext,
                               to_context: SceneContext) -> SceneTransition:
    ...
    def check_context_continuity(self, previous_context: SceneContext,
                               current_context: SceneContext,
                               memory: MemorySnapshot) -> ContextContinuity:
        ...
        try:
            ...
            issues, recommendations = self._analyze_continuity_issues(
                char_consistency, world_consistency, narrative_flow,
                previous_context, current_context
            )
    ...
    def generate_scene_prompt(self, scene_context: SceneContext,
    ...
    def update_scene_with_outcomes(self, scene_context: SceneContext,
                                 memory: MemorySnapshot,
                                 scene_outcomes: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if "world_state_changes" in scene_outcomes:
                ...
                self.world_manager.update_world_state(
                    memory, world_changes, source="scene", 
    ...
    def _determine_scene_mood(self, memory: MemorySnapshot, 
                            active_characters: List[str]) -> str:
        ...
        try:
            ...
            if any(mood in ["angry", "hostile", "frustrated"] for mood in character_moods):
                return "tense"
    ...
    def _create_scene_context_config(self, scene_type: str, 
                                   active_characters: List[str]) -> ContextConfiguration:
    ...
    def _determine_transition_type(self, from_context: SceneContext,
                                 to_context: SceneContext) -> str:
    ...
    def _calculate_time_elapsed(self, from_context: SceneContext,
                              to_context: SceneContext) -> Optional[str]:
    ...
    def _generate_continuity_notes(self, from_context: SceneContext,
                                 to_context: SceneContext) -> List[str]:
    ...
    def _check_character_consistency(self, prev_context: SceneContext,
                                   curr_context: SceneContext,
                                   memory: MemorySnapshot) -> float:
    ...
    def _check_world_state_consistency(self, prev_context: SceneContext,
                                     curr_context: SceneContext) -> float:
    ...
    def _check_narrative_flow(self, prev_context: SceneContext,
                            curr_context: SceneContext) -> float:
    ...
    def _analyze_continuity_issues(self, char_consistency: float,
                                 world_consistency: float,
                                 narrative_flow: float,
                                 prev_context: SceneContext,
                                 curr_context: SceneContext) -> Tuple[List[str], List[str]]:
