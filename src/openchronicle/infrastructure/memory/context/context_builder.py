...
class ContextBuilder:
    ...
    def build_memory_context(self, memory: MemorySnapshot, 
                           primary_characters: List[str] = None,
                           config: ContextConfiguration = None) -> str:
        """
    ...
    def build_character_focused_context(self, memory: MemorySnapshot,
                                      focus_character: str,
                                      config: ContextConfiguration = None) -> str:
        ...
        return self.build_memory_context(
            memory, 
            primary_characters=[focus_character],
            config=config
        )
    ...
    def build_comprehensive_context(self, memory: MemorySnapshot,
                                  primary_characters: List[str] = None) -> str:
    ...
    def analyze_context_metrics(self, context: str, memory: MemorySnapshot) -> ContextMetrics:
    ...
    def _build_character_context(self, memory: MemorySnapshot,
                               primary_characters: List[str],
                               config: ContextConfiguration) -> List[str]:
    ...
    def _build_world_state_context(self, memory: MemorySnapshot,
                                 config: ContextConfiguration) -> List[str]:
    ...
    def _build_flags_context(self, memory: MemorySnapshot,
                           config: ContextConfiguration) -> List[str]:
    ...
    def _build_events_context(self, memory: MemorySnapshot,
                            config: ContextConfiguration) -> List[str]:
    ...
    def _format_character_context(self, character: CharacterMemory, detail_level: str) -> str:
    ...
    def _calculate_context_completeness(self, context: str, memory: MemorySnapshot) -> float:
