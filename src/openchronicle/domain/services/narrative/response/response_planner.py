...
from .response_models import (
    ContextAnalysis, ResponsePlan, ResponseStrategy, 
    ResponseComplexity, ContextQuality
)
...
class ResponsePlanner(NarrativeComponent):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.quality_targets = config.get("quality_targets", {
    ...
    def _select_response_strategy(self, context_analysis: ContextAnalysis, 
                                preferences: Dict[str, Any]) -> ResponseStrategy:
        ...
        if quality == ContextQuality.EXCELLENT:
            candidates = [ResponseStrategy.CREATIVE, ResponseStrategy.ELABORATE, ResponseStrategy.CONTEXTUAL]
        elif quality == ContextQuality.GOOD:
            candidates = [ResponseStrategy.BALANCED, ResponseStrategy.ADAPTIVE, ResponseStrategy.CONTEXTUAL]
    ...
    def _determine_response_complexity(self, context_analysis: ContextAnalysis,
                                     preferences: Dict[str, Any]) -> ResponseComplexity:
    ...
    def _plan_content_focus(self, context_analysis: ContextAnalysis, 
    ...
    def _select_tone(self, context_analysis: ContextAnalysis, 
                   strategy: ResponseStrategy) -> str:
    ...
    def _select_style_guides(self, context_analysis: ContextAnalysis,
                           complexity: ResponseComplexity) -> List[str]:
    ...
    def _estimate_response_length(self, complexity: ResponseComplexity, 
                                content_focus: str) -> int:
    ...
    def _identify_key_points(self, context_analysis: ContextAnalysis,
                           strategy: ResponseStrategy) -> List[str]:
    ...
    def _set_quality_targets(self, complexity: ResponseComplexity,
                           strategy: ResponseStrategy) -> Dict[str, float]:
