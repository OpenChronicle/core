...
class TestStructureAnalyzer:
        ...
        for layer in self.hexagonal_layers:
            ...
            if layer_path.exists():
                ...
                if test_layer_path.exists():
                    ...
                    print(f"    Test files: 0 (no test directory)")
    ...
    def _output_report(self, analysis):
        ...
        # Next Steps
        print(f"\n🚀 NEXT STEPS:")
        print(f"1. Run 'python scripts/migrate_tests_to_hexagonal.py' to auto-migrate structure")
        print(f"2. Run 'python scripts/validate_hexagonal_tests.py' to validate compliance")
        print(f"3. Update import statements in failing tests")
        print(f"4. Add missing test files for uncovered modules")
