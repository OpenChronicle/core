...
from core.memory_management.redis_cache import (
    CacheConfig, CacheMetrics, MultiTierCache, 
    CachedCharacterManager, CachedMemoryOrchestrator
)
from core.memory_management.cache_benchmark import CachePerformanceBenchmark
from core.memory_management.memory_orchestrator import MemoryOrchestrator
from core.memory_management.character.character_manager import CharacterManager
from core.memory_management.memory_interfaces import MemorySnapshot, CharacterMemory
...
class TestMultiTierCache:
    ...
    async def test_cache_without_redis(self):
        ...
        with patch('core.memory_management.redis_cache.REDIS_AVAILABLE', False):
            config = CacheConfig()
